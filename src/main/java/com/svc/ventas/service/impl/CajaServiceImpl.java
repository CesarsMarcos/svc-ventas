...
public class CajaServiceImpl implements ICajaService {
    ...
    public CajaDetalleDTO findByFechaAndUsuario() {
        ...
        return cajaRepo.findByFechaAndUsuarioUsuario(AppUtils.obtenerFechaActual(), username)
    ...
    public Response aperturaCaja(CajaDTO caja) {
        ...
        caja.setEstado(Constantes.CAJA_ABIERTA);
    ...
    private UsuarioDto obtenerUsuarioLogueado() {
        ...
        return usuarioService.getPorUserName("cmarcos");
    }
    ...
    private BigDecimal calcularTotalCtaBancaria(Map<TipoPago, BigDecimal> totalesPorPago) {
        return List.of(TipoPago.TARJETA, TipoPago.TRANSFERENCIA, TipoPago.YAPE, TipoPago.PLIN).stream()
    ...
    private ResumenCajaDTO buildResumenCajaDTO(
        ...
        return ResumenCajaDTO.builder()
                ...
                .totalEgresos(totales.getTotalEgresos())
                .totalIngresos(totales.getTotalIngresos())
                .saldo(saldo)
                .montoInicialMasSaldo(montoInicialMasSaldo)

                .totalEfectivoEnCaja(finales.getTotalEfectivoEnCaja())
                .totalCtaBancaria(finales.getTotalCtaBancaria())
                .totalCuadre(finales.getTotalCuadre())
