...
public interface CajaMapper {
  ...
  @Mapping(target = "estado", source = "caja.estado")
  @Mapping(target = "moneda", expression  = "java(Constantes.MONEDA_PER)")
  ...
  @Mapping(target = "montoTexto", expression = "java(mapTotalCuadreATexto(finales.getTotalCuadre()))")
  ...
  default String mapTotalCuadreATexto(BigDecimal totalCuadre) {
    return NumeroATexto.convertir(totalCuadre, Constantes.MONEDA_PER);
  }
